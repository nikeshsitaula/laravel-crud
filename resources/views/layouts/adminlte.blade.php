...
{{--<img src="/storage/cover_images/{{'hero_bg_1.jpg'}}">--}}
{{--style="background-image: url('storage/cover_images/{{'hero_bg_1.jpg'}}');"--}}
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="nav-link {{Route::current()->getName() == 'admin.enquiry.index' ? 'active' : '' }}"><a
                        href="{{'/dashboard'}}">
                        <i class="fa fa-link"></i>
                        <span>Blog</span></a></li>
                <li class="nav-link {{Route::current()->getName() == 'admin.enquiry.index' ? 'active' : '' }}"><a href="/dashboard/offers">
                        <i class="fa fa-link"></i>
